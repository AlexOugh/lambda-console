(function() {
  'use strict'
  function defineHeaderGenerator() {
    ...
    var HeaderGenerator = {};
    HeaderGenerator.generate = function(verb, path, queryParams, body, endpoint, accessKey, secretKey, sessionToken, region) {
      ...
      var credentialScope = buildCredentialScope(date, region, serviceName);
      var stringToSign = buildStringToSign(date, credentialScope, hashedCanonicalRequest);
      var signingKey = calculateSigningKey(secretKey, date, region, serviceName);
      var signature = calculateSignature(signingKey, stringToSign);
      headers[AUTHORIZATION] = buildAuthorizationHeader(accessKey, credentialScope, headers, signature);
  ...
  if (typeof module === 'object' && typeof module.exports !== 'undefined') {
    module.exports = defineHeaderGenerator;
    return defineHeaderGenerator;
  }
